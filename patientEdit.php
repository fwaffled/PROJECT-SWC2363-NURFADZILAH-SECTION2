...
<a href ="patientList.php"><button class="btn epatient">Edit Your Data</button></a>
<a href ="appointmentP.php"><button class="btn appointment">Appointment</button></a>
...
<a href ="patientLogout.php"><button class="btn logout">Log Out</button></a>
</body>
</html>